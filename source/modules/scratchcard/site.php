...
class ScratchcardModuleSite extends WeModuleSite {
	...
	public function doMobileLottery() {
		...
		$mycredit = pdo_fetchall("SELECT description FROM ".tablename('scratchcard_winner')." WHERE from_user = '{$fromuser}' AND aid = '0' AND award <> '' AND rid = '$id' ORDER BY createtime DESC");
