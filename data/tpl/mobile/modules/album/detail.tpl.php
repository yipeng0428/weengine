...
<?php if($album['type'] == 1) { ?>
<script type="text/javascript" src="./source/modules/album/template/mobile/360view.js"></script>
<style>
...
.view_change{
    position: fixed; z-index: 1000; bottom:0; left: 0; width: 100%; height: 42px; background-color: #262626; border: 1px solid #000000;
...
<script type="text/javascript" src="./source/modules/album/template/mobile/klass.min.js"></script>
<script type="text/javascript" src="./source/modules/album/template/mobile/code.photoswipe.min.js"></script>
<script type="text/javascript" src="./source/modules/album/template/mobile/jquery.lazyload.js"></script>
<style>
	...
	<div class="body">
		...
		<div id="main">
			<ul id="gallery" class="gallery">
				...
				<li style="">
					<a href="<?php echo $_W['attachurl'];?><?php echo $row['attachment'];?>">
						<img src="<?php echo $_W['attachurl'];?><?php echo $row['attachment'];?>" alt="<?php echo $row['title'];?>">
					</a>
				</li>
				<?php } } ?>
			</ul>
