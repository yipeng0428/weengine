...
<div class="alert alert-info reply-market-list">
	<table class="tb reply-news-edit">
		...
		<tr>
			<th>奖品描述：</th>
			<td>
				<textarea style="height:80px;" name="award-description<?php echo $namesuffix;?>" class="span7" cols="70" id=""><?php echo $item['description'];?></textarea>
			</td>
		</tr>
		...
		<tr>
			<th>兑 换 码：</th>
			<td>
				<textarea style="height:80px;" class="span7" cols="70" id="" name="award-activation-code<?php echo $namesuffix;?>"><?php echo $item['activation_code'];?></textarea>
			</td>
		</tr>
		<tr>
			<th>激活地址：</th>
			<td>
				<input type="text" id="" class="span7" value="<?php echo $item['activation_url'];?>" name="award-activation-url<?php echo $namesuffix;?>">
			</td>
		</tr>
		<?php } ?>
	</table>
