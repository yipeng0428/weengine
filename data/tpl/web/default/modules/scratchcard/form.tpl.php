				...
				<td>
					<div id="" class="uneditable-input reply-edit-cover">
						<div class="detail">
							...
							<input type="button" id="scratchcard-picture" fieldname="picture<?php echo $namesuffix;?>" class="btn btn-mini reply-edit-cover-upload" value="<i class='icon-upload-alt'></i> 上传" style="" />
							<button type="button" class="btn btn-mini reply-news-edit-cover-remove" id="upload-delete" onclick="doDeleteItemImage(this, 'scratchcard-picture-value')" style="<?php if(empty($reply['picture'])) { ?> display:none;<?php } ?>"><i class="icon-remove"></i> 删除</button>
						</div>
						...
						<div id="upload-file-view" class="upload-view">
							<input type="hidden" id="scratchcard-picture-value" value="<?php echo $reply['picture'];?>">
