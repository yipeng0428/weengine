	...
	<div class="form form-horizontal">
		...
		<table class="tb">
			...
			<tr>
				...
				<td>
					当前模块与系统版本不兼容
					<a href="<?php echo create_url('setting/module/convert', array('id' => $module['name']))?>">转换模块版本</a>
				</td>
			</tr>
			<?php } else { ?>
			...
			<tr>
				...
				<td>
					...
					<?php if(!$module['issystem']) { ?><a href="<?php echo create_url('setting/module/uninstall', array('id' => $module['name']))?>">卸载此模块</a><?php } ?>
				</td>
			</tr>
			<?php } else { ?>
			<tr>
